...
export let listPage = 1;
export let gridPage = 1;
const LIST_PAGE_SIZE = 10;
const GRID_PAGE_SIZE = 9;

export const setListPage = (n) => { listPage = n; };
export const setGridPage = (n) => { gridPage = n; };
...
const renderPagination = (
  ...
  prev.innerHTML = '<i class="fa-solid fa-chevron-left text-[10px]" aria-hidden="true"></i>';
  ...
  next.innerHTML = '<i class="fa-solid fa-chevron-right text-[10px]" aria-hidden="true"></i>';
...
export const renderFractionalTable = () => {
                        ...
                        <div class="flex flex-wrap md:flex-nowrap gap-6">
                            <div class="flex-shrink-0 mb-5 md:mb-0">
                                <div class="h-40 w-40 bg-white rounded-xl border border-slate-200 p-4 flex items-center justify-center relative shadow-sm">
                                    <a href="#"><img src="${fixedImgUrl}" alt="${brandName} Ball End Mill" class="max-h-full object-contain" width="160" height="160" loading="lazy"></a>
                                </div>
                            </div>
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-center justify-between">
                                                <p class="text-success-available font-bold text-sm">
                                                    <i class="fa-solid fa-check mr-1" aria-hidden="true"></i> ${item.stock} In Stock
                                                </p>
                                            </div>
                                            <p class="text-slate-500 text-[11px] font-medium">
                                                <i class="fa-solid fa-location-dot mr-1" aria-hidden="true"></i> ${item.locStock} available in ${item.location}
                                            </p>
                                        </div>
                                        <div class="mt-6 flex flex-col gap-3">
                                            <div class="flex items-center justify-between gap-3">
                                                <label class="text-xs font-black uppercase text-slate-600" for="qty-${mscNum}">Qty</label>
                                                <input id="qty-${mscNum}" type="number" value="1" aria-label="Quantity" class="input input-bordered input-sm w-20 rounded-lg text-center font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus:border-primary">
                                            </div>
                                            <button 
...
export const renderFractionalList = () => {
    ...
    card.innerHTML = `
            <div class="w-full md:w-48 p-4 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-slate-100">
                <div class="h-32 w-32 flex items-center justify-center mb-4">
                    <img src="${fixedImgUrl}" alt="${brandName} Ball End Mill" class="max-h-full object-contain" width="128" height="128" loading="lazy">
                </div>
            ...
            <div class="w-full md:w-64 p-6 bg-slate-50/30 border-t md:border-t-0 md:border-l border-slate-100 flex flex-col">
                ...
                <div class="mt-auto space-y-4">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <input id="qty-list-${brandData.msc}" type="number" value="1" aria-label="Quantity" class="input input-bordered input-sm w-24 rounded-lg text-center font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus:border-primary bg-white shadow-sm">
                    </div>
                    <button 
...
export const renderFractionalGrid = () => {
    ...
    card.innerHTML = `
            <figure class="px-6 pt-6 relative">
                <div class="bg-slate-50 w-full rounded-2xl p-4 h-48 flex items-center justify-center group-hover:bg-white transition-colors">
                    <img src="${fixedImgUrl}" alt="${brandName} Ball End Mill" class="max-h-full object-contain mix-blend-multiply" width="200" height="200" loading="lazy">
                </div>
            </figure>
            <div class="card-body p-6">
                ...
                <div class="card-actions mt-6 flex gap-2">
                    <input id="qty-grid-${brandData.msc}" type="number" value="1" aria-label="Quantity" class="input input-bordered w-16 text-center font-bold text-sm focus:border-primary focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-xl bg-white">
                    <button 
